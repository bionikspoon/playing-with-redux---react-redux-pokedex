    ...
    loaders: [
      {
        ...
        loader: ExtractTextPlugin.extract('style-loader', [
          'css-loader', 'autoprefixer?browsers=last 2 version',
...
const commonChunkPlugin = new webpack.optimize.CommonsChunkPlugin('vendor',
  '[name].[hash].js');
...
// ----------------------------------
if (globals.__DEV__) {
  webpackConfig.entry.app.push(`webpack-dev-server/client?${config.get('webpack_public_path')}`,
